...
public class YellowSquares {
    ...
    static void drawFourSquares(double n, double xCenter, double yCenter, Graphics graphics) {
        if (n < 3) {
            return;
        }
        ...
        drawFourSquares(n / 3, xCenter, yCenter - n, graphics);
        drawFourSquares(n / 3, xCenter, yCenter + n, graphics);
        drawFourSquares(n / 3, xCenter - n, yCenter, graphics);
        drawFourSquares(n / 3, xCenter + n, yCenter, graphics);
